    ...
    <div class="container"> 
      ...
      <main class="form-signin">
        ...
        <?php include_once 'acoes/escreve-mensagem.php' ?>
          ...
          <div class='alert'> New account? <a class='btn btn-lg btn-warning' href='cadastrar-usuario.php'> Sign up </a> </div>
      
          <button class="w-100 btn btn-lg btn-primary" type="submit" name="bt_entrar">Sign in</button>
          <p class="mt-5 mb-3 text-muted"> MaxMatters &copy; 2022</p>
        </form>
      </main>
    </div>
  </body>
