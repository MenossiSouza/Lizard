<?php
    ...
    if(isset($_POST['bt_cadastrar'])) {
        ...
        // INSTRUÇÃO SQL
        $sql = "INSERT INTO formacoes (nivel, nome_curso, instituicao, ano_inicio, ano_termino, situacao, idusuario2) VALUES ('$nivel', '$nome_curso', '$instituicao', '$ano_inicio', '$ano_termino', '$situacao', '$idusuario')";
