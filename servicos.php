 ...
 <nav class="navbar navbar-expand-md navbar-light bg-light">
  <div class="container">
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <a class="navbar-brand" href="#">Conectar</a>
    </div>
...
<div class="container-fluid bg1 text-center cadcurso" id="quem">
  ...
  <h3>Conecte ao Banco de Dados do IBM MAXIMO</h3>
  ...
  <form action="acoes/cria-curso.php" method="POST" class="needs-validation container" novalidate>
    ...
    <div class="row g-12">
      ...
      <div class="col-sm-12">
        <label for="nome_curso" class="form-label">Endereço do banco(IP)</label>
      ...
      <div class="col-sm-12">
        <label for="instituicao" class="form-label">Usuario</label>
      ...
      <div class="col-md-12">
        <label for="ano_curso" class="form-label">Senha</label>
        <input type="password" class="form-control" id="ano_curso" name="ano_curso" min="1950" max="2050" step="1" required>
        <div class="invalid-feedback">
